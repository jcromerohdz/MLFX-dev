          ...
          <b-col md="4">
            ...
            >
              ...
              <div class="annual-plan">
                <div class="plan-price mt-2">
                  <sup class="font-medium-1 font-weight-bold text-primary">$</sup>
                  <span class="pricing-basic-value font-weight-bolder text-primary">{{ monthlyPlanShow ? 25:pricing.standardPlan.yearlyPlan.perMonth }}</span>
                  <sub class="pricing-duration text-body font-medium-1 font-weight-bold">/month</sub>
                </div>
                <small
                  v-show="!monthlyPlanShow"
...
export default {
  ...
  data() {
    ...
    return {
      ...
      lineItems: [
        {
          price: 'price_1In9yfDhvT9geSyOVMchfQgR', // The id of the recurring price you created in your Stripe dashboard
          quantity: 1,
        },
      ],
